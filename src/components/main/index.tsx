...
export default function Main() {
    return (
        <div className="min-h-screen md:mx-16 mx-4 relative flex flex-col justify-center items-center md:gap-16 sm:gap-8 gap-4">
            <Image src={Logo} className="fade-down-animation" alt="Geniusla Logo, Geniusla Discord, Geniusla Site, Geniusla Website" />
            ...
            <Image src={Arrow} className="animate-bounce absolute bottom-4" alt="Geniusla Logo, Geniusla Discord, Geniusla Site, Geniusla Website" />
        </div>
    )
}